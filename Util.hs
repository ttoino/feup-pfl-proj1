...
-- | Returns the digits of a number in base 10
digits :: Integral a => a -> [Int]
digits 0 = []
digits n = digits (n `div` 10) ++ [fromIntegral (n `mod` 10)]

-- | Converts an integral to its superscripted representation
showSuperscript :: Integral a => a -> String
showSuperscript e = map (supers !!) (digits e)
  where
    supers = "⁰¹²³⁴⁵⁶⁷⁸⁹"

-- | Converts an integral to its subscripted representation
